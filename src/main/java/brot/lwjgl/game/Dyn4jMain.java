...
import brot.lwjgl.game.scene.Dyn4jScene;
 ...
 * - layer show, hide
 */
public class Dyn4jMain implements AppLogic {
    private Dyn4jScene tiledMapScene;

    public static void main(String[] args) {
        Dyn4jMain main = new Dyn4jMain();
