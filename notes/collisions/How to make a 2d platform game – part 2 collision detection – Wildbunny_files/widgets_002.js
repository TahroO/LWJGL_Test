  ...
  STMBLPN.collectBadgeData = function() {
    try {
      ...
      var params = {
        ...
        'utmt': 'event',
        'utmr': 'https://web.archive.org/web/20191209004554/http://www.stumbleupon.com/refer.php',
  ...
  (function() {
      ...
      STMBLPN.Widget.sendBadgeData = function() {
        try {
          ...
          if (!data)
            return;
          top.postMessage(data, 'https://web.archive.org/web/20191209004554/http://www.stumbleupon.com');
        } catch (e){ }
      };
...
/*
     FILE ARCHIVED ON 00:45:54 Dec 09, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:45:50 Mar 28, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.09
  esindex: 0.008
  LoadShardBlock: 121.011 (6)
  PetaboxLoader3.datanode: 80.768 (7)
  load_resource: 379.539
  PetaboxLoader3.resolve: 339.948
*/